...
(
   CORRELATIVO_CONTRATO bigint not null auto_increment,
   DUI_CLIENTE          char(10) not null,
...
create table PERFIL
(
   ID_PERFIL            smallint not null auto_increment,
   NOMBRE_PERFIL        varchar(16) not null,
...
(
   ID_RECOMENDADO       bigint not null auto_increment,
   DUI_CLIENTE          char(10) not null,
...
(
   ...
   DUI_CLIENTE          char(10) not null,
   TIPO_TELEFONO        varchar(32) not null,
